...
//'Constructor' class modified for NEATOBot
// Not inheriting because 'Constructor' class is a singleton
// Eliminates all the automatic actions that were handled by the Constructor
class NEATOConstructor {
private:
	static NEATOConstructor* instance;
...
public:
	...
	static NEATOConstructor* getInstance();
